...
See below for an example using the map method on the users array to return a new array containing the names & age of the users as elements.
...
const age = user.map(a => a.age);
console.log(names);
console.log(age);
The console would display the value  [ 'John', 'Amy', 'camperCat' ] and [34, 20, 10]
*/
